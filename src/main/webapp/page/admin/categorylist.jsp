                    ...
                    <div class="page-section">
                        <div class="card card-fluid">
                            <div class="card-body">
                                ...
                                <!-- Filter by status (search removed) -->
                                <div class="row mb-3">
                                    <div class="col-12">
                                                ...
                                                <c:forEach var="c" items="${list}">
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <span class="badge badge-${c.status == 1 ? 'success' : 'danger'}">
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                                <a class="page-link"
                                                                   href="${pageContext.request.contextPath}/admin/category?page=${i}&status=${status}">
                                                                    ${i}
                                                                </a>
                                                            </li>
                                                        </c:forEach>
