                ...
                <div class="page-inner">
                    ...
                    <header class="page-title-bar">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/providers/add" class="btn btn-success">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <!-- Pagination removed (display whatever list servlet returns) -->
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
